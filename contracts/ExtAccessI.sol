...
contract ExtAccessI {
    ...
    */
    function getExtAccessKey() public constant returns (
        address authKey0, 
        address authKey1, 
        address authKey2, 
        address authKey3,
    ...
    */
    function getPreAuthKey() public constant returns (address) {
    ...
    */
    function getPreAuthExpiry() public constant returns (uint) {
