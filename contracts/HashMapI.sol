...
contract HashMapI {
     ...
     */
	function isActive(bytes32 _hash) public constant returns (bool) {
     ...
     */
    function isArchived(bytes32 _hash) public constant returns (bool) {
    ...
    */
	function isValid(bytes32 _hash) public constant returns (bool) {
     ...
     */
    function get(uint _idx) public constant returns (bytes32) {
