...
contract IntAccessI {
    ...
    */
    function getContractAdr() public constant returns (
    ...
    function getTrustAdr() public constant returns (address) { return trustAdr; }
    function getPoolAdr() public constant returns (address) { return poolAdr; }
    function getBondAdr() public constant returns (address) { return bondAdr; }
    function getBankAdr() public constant returns (address) { return bankAdr; }
    function getPolicyAdr() public constant returns (address) { return policyAdr; }
    function getSettlementAdr() public constant returns (address) { return settlementAdr; }
    function getAdjustorAdr() public constant returns (address) { return adjustorAdr; }
    function getTimerAdr() public constant returns (address) { return timerAdr; }
}