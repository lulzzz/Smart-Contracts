...
contract Settlement is SetupI, IntAccessI, HashMapI {
    ...
    */
        ...
        isAdjustorSettlementPermissioned(_adjustorHash, 0)
    {
        ...
        LogSettlement(settlementHash, _adjustorHash, _policyHash, now, uint(dataStorage[settlementHash].state));
        ...
        if (_documentHash != 0x0) {
            ...
            // Add log entry
            LogSettlement(settlementHash, _adjustorHash, _documentHash, now, uint(dataStorage[settlementHash].state));
        }
    }
        ...
        isAdjustorSettlementPermissioned(_adjustorHash, 0)
    {
        ...
        // Add log entry
        LogSettlement(_settlementHash, _adjustorHash, _documentHash, now, uint(dataStorage[_settlementHash].state));
    }
